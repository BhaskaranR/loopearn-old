  ...
  switch (locale) {
    case "en":
      return {
        ...
        "invite.subject": `${params?.invitedByName} invited you to the ${params?.teamName} team on LoopEarn`,
        "invite.preview": `Join ${params?.teamName} on LoopEarn`,
        "invite.title1": "Join",
        "invite.title2": "on",
    ...
    case "sv":
      return {
        ...
        "invite.subject": `${params?.invitedByName} bjöd in dig till ${params?.teamName} på Relistex`,
        "invite.preview": `Gå med i ${params?.teamName} på Relistex`,
