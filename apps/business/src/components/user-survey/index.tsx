import { AnimatedSizeContainer } from "@loopearn/ui/animated-size-container";
import { ClientOnly } from "@loopearn/ui/client-only";
import { cn } from "@loopearn/ui/cn";
import { CheckCircleFill } from "@loopearn/ui/icons";
import { Popover } from "@loopearn/ui/popover";
...
export default async function UserSurveyButton() {
          ...
          {!hidden && (
            <motion.div exit={{ opacity: 0 }} className="p-2">
              ...
              >
                ...
                >
                  Where did you hear about LoopEarn?
                </button>
              </Popover>
            </motion.div>
          )}
