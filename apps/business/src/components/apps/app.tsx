...
import { Sheet, SheetContent, SheetHeader } from "@loopearn/ui/sheet";
        ...
        <SheetContent>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <span className="text-xs text-[#878787]">
                    {category} • Published by Loopearn
                  </span>
                </div>
              </div>
          ...
          <div className="absolute bottom-4 pt-8 border-t border-border">
            <p className="text-[10px] text-[#878787]">
              All apps on the Loopearn App Store are open-source and
              peer-reviewed. Apps published by Loopearn are officially
              certified. Report any concerns about app content or behavior.
            </p>

            <a
              href="mailto:support@loopearn.com"
