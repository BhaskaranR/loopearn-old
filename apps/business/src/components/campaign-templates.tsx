...
export const CampaignTemplates: Template[] = [
  ...
  },
  {
    id: "youtube",
    title: "YouTube",
    description: "Reward customers for sharing on YouTube",
    type: "action-based",
    category: "Types",
    icon: Youtube,
    usageCount: 198,
    items: [
      ...
      },
      {
        ...
        title: "Subscribe",
        icon: UserPlus,
        description: "Reward customers for subscribing to YouTube",
      },
      {
        id: "like",
        title: "Like",
        icon: ThumbsUp,
        description: "Reward customers for liking videos on YouTube",
      },
      {
        id: "comment",
        title: "Comment",
        icon: MessageCircle,
        description: "Reward customers for commenting videos on YouTube",
      },
    ],
  },
  {
