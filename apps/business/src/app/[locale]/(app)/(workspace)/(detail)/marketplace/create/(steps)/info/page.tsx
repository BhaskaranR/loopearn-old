...
export default async function UpdateAddress({
  ...
  const defaultAddress = business.business_address[0];
      ...
      >
        <div className="relative flex flex-col items-center min-h-screen ">
          <div className="flex w-full flex-col items-center ">
            <StepPage
              title="Confirm your store address"
              className="w-full max-w-xl mx-auto"
            >
              <div className="animate-slide-up-fade w-full [--offset:10px] [animation-delay:500ms] [animation-duration:1s] [animation-fill-mode:both] px-4">
                <UpdateAddressForm
                  business={business}
                  address={defaultAddress}
                  slug={slug}
                  redirectTo={"/marketplace/create/description"}
                />
              </div>
            </StepPage>
          </div>
