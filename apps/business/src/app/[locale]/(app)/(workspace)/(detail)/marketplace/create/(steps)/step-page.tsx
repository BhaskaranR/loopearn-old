...
import type { Icon } from "@loopearn/ui/icons";
...
export function StepPage({
  ...
  return (
    ...
    >
      ...
      <h1 className="text-center text-2xl font-medium leading-tight">
        {title}
      </h1>
      {description && (
        <p className="mt-1.5 text-center text-base leading-tight text-gray-500 text-muted-foreground">
          {description}
        </p>
      )}
