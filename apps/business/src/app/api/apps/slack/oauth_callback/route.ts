import { createApp } from "@loopearn/app-store/db";
import {
  config,
  createSlackApp,
  slackInstaller,
          ...
          blocks: [
            {
              ...
              text: {
                type: "mrkdwn",
                text: "Hello there! 👋 I'm your new Loopearn bot, I'll send notifications in this channel regarding new transactions and other important updates.\n\n Head over to the <slack://app?id=A07PN48FW3A&tab=home|Midday Assistant> to ask questions.",
              },
            },
            {
              type: "divider",
            },
            {
              ...
              elements: [
                {
                  type: "mrkdwn",
                  text: "<https://app.loopearn.com/apps?app=slack&settings=true|Notification settings>",
                },
              ],
            },
          ],
