...
export const siteConfig = {
  ...
  subDescription:
    "Unlock Potential, Earn Rewards: The Community-Powered Platform",
  list: "List your business",
  cta: "Get Started",
  url: process.env.NEXT_PUBLIC_APP_URL || "http://localhost:3000",
  keywords: ["LoopEarn", "Earn While You Learn", "Local Business", "Community"],
  links: {
    email: "support@loopearn.com",
    twitter: "https://twitter.com/loopearn",
    discord: "https://discord.gg/loopearn",
    github: "https://github.com/loopearn",
  ...
  features: [
    {
      ...
      description:
        "Earn while you learn by completing tasks and earning points.",
      icon: <BrainIcon className="h-6 w-6" />,
    },
    {
      name: "Connect with Local Businesses",
      description:
        "Connect with your favorite local businesses and earn rewards.",
      icon: <ClockIcon className="h-6 w-6" />,
    },
    {
      name: "Earn Rewards",
      description: "Earn rewards by completing tasks and earning points.",
    ...
    },
    {
      ...
      description:
        "Your personal AI agent that helps you increase your earnings.",
      icon: <BellIcon className="h-6 w-6" />,
    },
    {
      name: "Customizable Rewards",
      description: "Locally-sourced rewards from your favorite businesses.",
      icon: <CalendarIcon className="h-6 w-6" />,
    },
  ],
  featureHighlight: [
  ...
  faqs: [
    ...
    {
      question: "Can I integrate LoopEarn with other apps?",
      answer: (
        <span>
          Yes, LoopEarn integrates with popular productivity tools and calendar
