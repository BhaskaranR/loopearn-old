    ...
    <>
      <div className="mx-auto mt-24 w-full max-w-screen-xl px-2.5 lg:px-20">
        <div className="py-16 text-center">
          <h1 className="text-foreground text-3xl font-bold sm:text-4xl">Articles</h1>
          <p className="text-muted-foreground mt-4 text-xl">Latest news and updates from {siteConfig.name}</p>
        </div>
      </div>
