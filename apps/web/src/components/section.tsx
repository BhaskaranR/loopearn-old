...
export default function Section({ id, title, subtitle, description, children, className }: SectionProps) {
      ...
      <div className={className}>
        <div className="relative container mx-auto max-w-7xl px-4 py-16">
          <div className="mx-auto space-y-4 pb-6 text-center">
            {title && (
              <h2 className="text-primary font-mono text-sm font-medium tracking-wider uppercase">{title}</h2>
            )}
            {subtitle && (
