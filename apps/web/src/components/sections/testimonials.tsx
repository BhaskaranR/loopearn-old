...
const testimonials = [
  {
    ...
    description: (
      <p>
        ...
        <Highlight>Insights are now more accurate and faster than ever.</Highlight> A game-changer for tech
        companies.
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        Implementing #AIStream&apos;s customer prediction model has drastically improved our targeting
        strategy.
        <Highlight>Seeing a 50% increase in conversion rates!</Highlight> Highly recommend their solutions.
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        As a startup, we need to move fast and stay ahead. #CodeAI&apos;s automated coding assistant helps us
        do just that.
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <Highlight>Localization is now seamless and efficient.</Highlight> A must-have for global product
        teams.
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        ...
        <Highlight>Our investment strategies are now powered by real-time data analytics.</Highlight>{" "}
  ...
  },
  {
    ...
    description: (
      <p>
        By integrating #GreenTech&apos;s sustainable energy solutions, we&apos;ve seen a significant reduction
        in carbon footprint.
        <Highlight>Leading the way in eco-friendly business practices.</Highlight> Pioneering change in the
        industry.
      </p>
    ),
  },
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <Highlight>Technology and healthcare working hand in hand for better health.</Highlight> A milestone
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <Highlight>Education tailored to every learner&apos;s needs.</Highlight> Transforming the educational
        landscape.
      </p>
    ),
  },
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <Highlight>Bringing creativity and technology together.</Highlight> A game-changer for creative
        industries.
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        #VentureAI&apos;s insights into startup ecosystems have been invaluable for our growth and funding
        strategies.
        <Highlight>Empowering startups with data-driven decisions.</Highlight> A catalyst for startup success.
      </p>
    ),
  },
];
