...
const AccordionContent = forwardRef<HTMLDivElement, AccordionContentProps>(
  ({ children, className, ...props }, forwardedRef) => (
    <Accordion.Content
      className={cn("data-[state=closed]:animate-slide-up data-[state=open]:animate-slide-down", className)}
      {...props}
      ref={forwardedRef}>
      ...
      <div className="container">
        <div className="mx-auto max-w-6xl">
          <div className="">
                  ...
                  <AccordionItem key={item.id} className="relative mb-8" value={`item-${index}`}>
                    ...
                    <AccordionTrigger>
                      <div className="relative flex flex-col items-center">
                        ...
                        <div className="mb-4 justify-center text-center">{item.content}</div>
                      </div>
                    </AccordionTrigger>
                  </AccordionItem>
                ))}
            ...
            {/* <div className={`relative w-auto overflow-hidden rounded-lg ${ltr && "md:order-1"}`}>
